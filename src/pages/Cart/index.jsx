      ...
      <div>
          ...
          <div className={styles.cart__item}>
            ...
            <div className={styles.cart__counter}>
              <div className={styles.cart__item_count}>
                <div className={cn(styles.cart__button, styles.cart__button__outline, styles.cart__button_circle, styles.cart__button_minus)}>
                  <svg
                    width="10"
                    height="10"
                    viewBox="0 0 10 10"
              ...
              <div className={styles.cart__item_price}>
                <b className={styles.cart__item_price_item}>770 ₽</b>
              </div>
            </div>
        ...
        <div className={styles.cart__bottom}>
          ...
          <div className={styles.cart__bottom_buttons}>
            ...
            <div className={cn(styles.cart__button, styles.cart__bottom_buttons_paybtn)}>
